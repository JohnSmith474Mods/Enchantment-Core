...
public class EnchantmentEffectComponentRegistry {
     ...
     */
    public static final Supplier<MapCodec<SetFireDurationEffect>> SET_FIRE_DURATION = register(
     ...
     */
    public static final Supplier<MapCodec<ExplosionEffect>> EXPLOSION_ENTITY = register(
            ExplosionEffect.KEY,
     ...
     */
    public static final Supplier<MapCodec<HealingEntityEffect>> HEALING_ENTITY_EFFECT = register(
     ...
     */
    public static final Supplier<MapCodec<DropItemEffect>> DROP_ITEM_EFFECT = register(
            DropItemEffect.KEY,
     ...
     */
    public static final Supplier<MapCodec<SpellFieldComponent>> SPELL_FIELD = register(
     ...
     */
    public static final Supplier<MapCodec<InvulnerabilityFrameModifierEffect>> INVULNERABILITY_FRAME_MODIFIER_EFFECT = register(
     ...
     */
    public static final Supplier<MapCodec<AreaGravityDamageEffect>> AREA_GRAVITY_DAMAGE = register(
     ...
     */
    public static final Supplier<MapCodec<SummonSpellFieldAnchorEffect>> SUMMON_SPELL_FIELD_ANCHOR = register(
     ...
     * @param codecSupplier  The codec supplier instance to register.
     * @param <T>            The type of the effect, extending {@link EnchantmentEntityEffect}.
     * @return The registered {@link MapCodec} supplier.
     */
    private static <T extends EnchantmentEntityEffect> Supplier<MapCodec<T>> register(
            String name,
        ...
        return register(name, codecSupplier);
    }
     ...
     * @return The registered {@link MapCodec} supplier.
     */
    private static <T extends EnchantmentEntityEffect> Supplier<MapCodec<T>> register(String name, Supplier<MapCodec<T>> codecSupplier) {
        return Services.REGISTRIES.register(
     ...
     */
    public static final Supplier<MapCodec<ExplosionEffect>> EXPLOSION_LOCATION = Services.REGISTRIES.register(
     ...
     */
    public static final Supplier<DataComponentType<FluidFogDensityEffect>> FLUID_FOG_DENSITY = register(
     ...
     */
    public static final Supplier<DataComponentType<BowChargeTimeEffect>> BOW_CHARGE_TIME = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<HomingProjectileEffect>>>> PROJECTILE_HOMING = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<RicochetProjectileEffect>>>> PROJECTILE_RICOCHET = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<MagneticProjectileEffect>>>> PROJECTILE_MAGNETIC = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<ShrapnelProjectileEffect>>>> PROJECTILE_SHRAPNEL = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<AutoSmeltEffect>>>> AUTO_SMELT = register(
            AutoSmeltEffect.KEY,
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<ExperienceYieldEffect>>>> EXPERIENCE_YIELD_MULTIPLIER = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<FluidWalkerEffect>>>> FLUID_WALKER = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<BuoyancyEffect>>>> BUOYANCY = register(
            BuoyancyEffect.KEY,
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<MultiJumpEffect>>>> MULTI_JUMP = register(
            MultiJumpEffect.KEY,
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<DamageHealingEffect>>>> ON_DAMAGE_HEALING = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<ClimbingEffect>>>> CLIMBING = register(
            ClimbingEffect.KEY,
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<TransparencyEffect>>>> TRANSPARENCY = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<StreakEffect>>>> MINING_STREAK = register(
     ...
     */
    public static final Supplier<DataComponentType<List<ConditionalEffect<StreakEffect>>>> DAMAGE_STREAK = register(
     ...
     * @return The registered {@link DataComponentType} supplier.
     */
     ...
     */
    public static final Supplier<DataComponentType<Float>> STORED_SMELTING_XP = Services.REGISTRIES.register(
